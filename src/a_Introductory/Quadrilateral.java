...
public class Quadrilateral {
	...
	public Boolean isSquare() {
		//change from l1.isSameLengthAs(l3) to l1.isSameLengthAs(l2)
		return (isRectangle() && l1.isSameLengthAs(l2) && // fix the length comparison to l2
				l2.isSameLengthAs(l3) && l3.isSameLengthAs(l4) && l4.isSameLengthAs(l1));
	}
}
