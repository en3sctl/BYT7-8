...
public class Money implements Comparable {
	...
	public String toString() {
		...
		String tmp1 = (this.amount != 0) ? amountString.substring(0, amountString.length() - 2) : "0";
		String tmp2 = (this.amount != 0) ? amountString.substring(amountString.length() - 2) : "00";
		return tmp1 + "." + tmp2 + " " + this.currency.getName();
	}
